...
export class SubGroupComponent implements OnInit {
   ...
   * Creates a new subgroup by sending the provided payload to the backend. Reloads the subgroup list 
   * upon successful creation.
   * @param {Partial<SubGroup>} payload - The data for the new subgroup, containing marketCode, subGroupCode, and subGroupName.
   */
